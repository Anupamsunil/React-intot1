    ...
    return(
        ...
        <div className=" row cards">
            <div className="col">
                <div className="aboutCard  ">
                    <div className="imgcard">
                        <img src="assets/images/card-img-1.png" alt="card-img-1" />
                    </div>
            ...
            <div className="col">
                <div className="aboutCard  ">
                    <div className="imgcard">
                        <img src="assets/images/card-img-2.png" alt="card-img-2" />
                    </div>
                    <div className="cardtittle">
            ...
            <div className="col">
                <div className="aboutCard  ">
                    <div className="imgcard">
                        <img src="assets/images/card-img-3.png" alt="card-img-3"/>
                    </div>
                    <div className="cardtittle">
